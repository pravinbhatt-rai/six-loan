...
export const metadata: Metadata = {
    ...
    openGraph: {
        title: 'Personal Loan up to 20 Lakh | Best Offers 2026',
        description: 'Find and compare personal loans up to 20 lakh in India 2026. Get instant approval, low interest rates, flexible EMI, and apply online for your ₹20,00,000 personal loan.',
        url: 'https://sixfinance.app/personalLoan/20-lakh',
        siteName: 'SixFinance',
        type: 'website',
    },
};
...
export default function FiveLakhPersonalLoanPage() {
    return (
        <>
            <PreHero id="personal-loan-20-lakh" />
            <EMICalculator
                marketingContent={{
                    tagline: "₹20 Lakh Personal Loan Calculator",
                    headline: (
                        <>
                            Plan Your <br />
                            <span className="text-teal-600">₹20 Lakh Loan EMI</span>
                        </>
                    ),
                    description: "Calculate accurate monthly payments for your ₹20,00,000 personal loan. Adjust the tenure to find an EMI that fits your monthly budget perfectly without overextending.",

                    features: [
                        {
                            icon: <Percent size={20} />,
                            title: "Optimized Rates",
                            desc: "Interest rates for ₹20 Lakh loans starting at just 20.49% p.a."
                        },
                        {
                            icon: <Wallet size={20} />,
                            title: "Collateral Free",
                            desc: "Get ₹20,00,000 instantly without pledging any assets or security."
                        },
                        {
                            icon: <Zap size={20} />,
                            title: "24-Hour Disbursal",
                            desc: "Pre-approved ₹20L limits are often credited within hours of application."
                        },
                        {
                ...
                title="Calculate Your ₹20L Repayment"
                currencySymbol="₹"

                // Default set strictly to 20 Lakhs for this landing page
                defaultAmount={2000000}
                minAmount={200000}
                maxAmount={2000000} // Capped at 20L to keep focus on mid-sized loans (optional)
            ...
            <UniversalLoanCard
                ...
                amountRange="20-lakh"
            />
            <LoanInfoSection pageId="20-lakh" />
            <SalaryLoanOffers />
            <EmiCalculationTable pageId="20-lakh" />
        </>
    );
}