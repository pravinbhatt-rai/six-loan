...
export const metadata: Metadata = {
    ...
    openGraph: {
        title: 'Personal Loan up to 40 Lakh | Best Offers 2026',
        description: 'Find and compare personal loans up to 40 lakh in India 2026. Get instant approval, low interest rates, flexible EMI, and apply online for your ₹40,00,000 personal loan.',
        url: 'https://sixfinance.app/personalLoan/40-lakh',
        siteName: 'SixFinance',
        type: 'website',
    },
};
...
export default function FiveLakhPersonalLoanPage() {
    return (
        <>
            <PreHero id="personal-loan-40-lakh" />
            <EMICalculator
                marketingContent={{
                    tagline: "₹40 Lakh Personal Loan Calculator",
                    headline: (
                        <>
                            Plan Your <br />
                            <span className="text-teal-600">₹40 Lakh Loan EMI</span>
                        </>
                    ),
                    description: "Calculate accurate monthly payments for your ₹40,00,000 personal loan. Adjust the tenure to find an EMI that fits your monthly budget perfectly without overextending.",

                    features: [
                        {
                            icon: <Percent size={20} />,
                            title: "Optimized Rates",
                            desc: "Interest rates for ₹40 Lakh loans starting at just 40.49% p.a."
                        },
                        {
                            icon: <Wallet size={20} />,
                            title: "Collateral Free",
                            desc: "Get ₹40,00,000 instantly without pledging any assets or security."
                        },
                        {
                            icon: <Zap size={20} />,
                            title: "24-Hour Disbursal",
                            desc: "Pre-approved ₹40L limits are often credited within hours of application."
                        },
                        {
                ...
                title="Calculate Your ₹40L Repayment"
                currencySymbol="₹"

                // Default set strictly to 40 Lakhs for this landing page
                defaultAmount={4000000}
                minAmount={400000}
                maxAmount={4000000} // Capped at 40L to keep focus on mid-sized loans (optional)
            ...
            <UniversalLoanCard
                ...
                amountRange="40-lakh"
            />
            <LoanInfoSection pageId="40-lakh" />
            <SalaryLoanOffers />
            <EmiCalculationTable pageId="40-lakh" />
        </>
    );
}