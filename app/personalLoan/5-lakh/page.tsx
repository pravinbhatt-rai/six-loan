...
export const metadata: Metadata = {
    ...
    openGraph: {
        title: 'Personal Loan up to 5 Lakh | Best Offers 2026',
        description: 'Find and compare personal loans up to 5 lakh in India 2026. Get instant approval, low interest rates, flexible EMI, and apply online for your ₹5,00,000 personal loan.',
        url: 'https://sixfinance.app/personalLoan/5-lakh',
        siteName: 'SixFinance',
        type: 'website',
    },
};
...
export default function FiveLakhPersonalLoanPage() {
    return (
        <>
            <PreHero id="personal-loan-5-lakh" />
            <EMICalculator
                marketingContent={{
                    tagline: "₹5 Lakh Personal Loan Calculator",
                    headline: (
                        <>
                            Plan Your <br />
                            <span className="text-teal-600">₹5 Lakh Loan EMI</span>
                        </>
                    ),
                    description: "Calculate accurate monthly payments for your ₹5,00,000 personal loan. Adjust the tenure to find an EMI that fits your monthly budget perfectly without overextending.",

                    features: [
                        {
                            icon: <Percent size={20} />,
                            title: "Optimized Rates",
                            desc: "Interest rates for ₹5 Lakh loans starting at just 10.49% p.a."
                        },
                        {
                            icon: <Wallet size={20} />,
                            title: "Collateral Free",
                            desc: "Get ₹5,00,000 instantly without pledging any assets or security."
                        },
                        {
                            icon: <Zap size={20} />,
                            title: "24-Hour Disbursal",
                            desc: "Pre-approved ₹5L limits are often credited within hours of application."
                        },
                        {
                ...
                title="Calculate Your ₹5L Repayment"
                currencySymbol="₹"

                // Default set strictly to 5 Lakhs for this landing page
            ...
            />
            <LoanInfoSection pageId="5-lakh" />
            <SalaryLoanOffers />
            <EmiCalculationTable pageId="5-lakh" />
        </>
    );
}