...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://sixfinance.app/creditinfo/forex',
  },
  keywords: [
  ...
  openGraph: {
    title: 'Forex Credit Cards India 2026 | Best Cards for Foreign Exchange',
    description: 'Compare and apply for the best forex credit cards in India. Enjoy low forex markup, global acceptance, and travel benefits. Updated for 2026.',
    url: 'https://sixfinance.app/creditinfo/forex',
    siteName: 'SixFinance',
    type: 'website',
  },
};

export default function ForexCreditCardLayout({ children }: { children: ReactNode }) {
  return <>{children}</>;
}
