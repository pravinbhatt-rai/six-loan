...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'International Credit Cards India 2026 | Best Cards for Global Use',
    description: 'Compare and apply for the best international credit cards in India. Enjoy global acceptance, low forex markup, and travel benefits. Updated for 2026.',
    url: 'https://sixfinance.app/creditinfo/international',
    siteName: 'SixFinance',
    type: 'website',
  },
};

export default function InternationalCreditCardLayout({ children }: { children: ReactNode }) {
  return <>{children}</>;
}
