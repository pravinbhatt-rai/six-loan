...
export async function generateMetadata(): Promise<Metadata> {
  const canonicalUrl =
    "https://sixfinance.app/loanAgainstSecurity/10-lakh";

  return {
    title:
      "₹10 Lakh Loan Against Securities | Interest Rate & Eligibility – Six Finance",
    description:
      "Apply for a ₹10 lakh loan against securities with Six Finance. Get instant funds against shares, mutual funds, or bonds without selling your investments.",

    keywords: [
      "10 lakh loan against securities",
      "₹10 lakh las",
      "loan against securities 10 lakh",
      "loan against shares 10 lakh",
      "loan against mutual funds 10 lakh",
      "loan against bonds",
    ...
    openGraph: {
      title: "₹10 Lakh Loan Against Securities | Six Finance",
      description:
        "Unlock instant liquidity with a ₹10 lakh loan against securities. Leverage shares or mutual funds without selling them.",
      url: canonicalUrl,
    ...
    twitter: {
      ...
      title: "₹10 Lakh Loan Against Securities | Six Finance",
      description:
        "Get a ₹10 lakh loan against securities with competitive interest rates and flexible repayment options.",
    },
