    ...
    <div className="space-y-6 animate-fadeIn">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-3">
          <div className="w-12 h-12 bg-green-500 flex items-center justify-center shadow-md">
            <Shield className="w-7 h-7 text-white" />
          </div>
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Add New Insurance</h1>
            <p className="text-gray-600 mt-1">Create a new insurance product</p>
          </div>
        </div>
      </div>
