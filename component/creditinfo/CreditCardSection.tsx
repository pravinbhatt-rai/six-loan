...
export default function CreditCardSection() {
  ...
  return (
    <section className="bg-white w-full py-10 md:py-16">
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 px-4 sm:px-6 lg:px-8 items-start">
        {/* Left content */}
        <div className="space-y-5 md:space-y-6 sticky top-20">
          <div className="inline-flex rounded-full bg-emerald-50 px-4 py-1">
          ...
          <button 
            ...
            className="group mt-4 inline-flex items-center justify-center gap-2 rounded-lg border border-gray-400 px-5 py-2.5 text-sm md:text-base font-medium text-gray-700 hover:border-gray-700 hover:text-gray-900 transition-colors"
          >
