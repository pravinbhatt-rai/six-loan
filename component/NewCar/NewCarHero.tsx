...
import { ArrowRight, Car, Key, Gauge, CheckCircle2 } from 'lucide-react';

// Placeholders - specialized for New Car theme
const CAR_IMAGE_URL = "https://images.unsplash.com/photo-1617788138017-80ad40651399?q=80&w=2070&auto=format&fit=crop"; 
// Alternative: A sleek modern car interior or exterior

const AVATAR_1 = "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=64&h=64";
const AVATAR_2 = "https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&w=64&h=64";
const AVATAR_3 = "https://images.unsplash.com/photo-1599566150163-29194dcaad36?auto=format&fit=crop&w=64&h=64";

export const NewCarHero: React.FC = () => {
  return (
    <div className="relative min-h-[800px] w-full flex items-center justify-center overflow-hidden font-sans bg-slate-50">
      ...
      <div className="absolute inset-0 z-0">
        ...
        {/* Subtle Grid Pattern for "Technical/Automotive" feel */}
      ...
      <div className="max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-0 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
            ...
            <div className="pt-6 border-t border-slate-200 w-full">
              <div className="flex items-center gap-4">
                ...
                <div className="text-sm">
                  <p className="font-bold text-slate-900">25,000+ Cars Financed</p>
                  <p className="text-slate-500">Partnered with Top Brands</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="relative h-[500px] lg:h-[650px] w-full flex items-center justify-center order-1 lg:order-2">
            ...
            {/* Element 1: Sanction Letter Badge */}
            <div className="absolute -left-6 top-20 z-20 bg-white p-4 rounded-2xl shadow-xl border border-slate-100 animate-bounce-slow max-w-[180px]">
              <div className="flex items-center gap-3 mb-2">
                ...
                <span className="text-xs font-bold text-slate-800">Instant Sanction</span>
              </div>
              <div className="h-1.5 w-full bg-slate-100 rounded-full overflow-hidden">
                <div className="h-full bg-green-500 w-[90%]"></div>
              </div>
              <p className="text-[10px] text-slate-500 mt-1 text-right">Approved in 30m</p>
            </div>

            {/* Element 2: Interest Rate Badge */}
            <div className="absolute -right-4 bottom-32 z-20 bg-white p-4 rounded-2xl shadow-xl border border-slate-100 animate-float max-w-[200px]">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-sm font-bold text-slate-900">Ownership in 24h</p>
                  <p className="text-xs text-slate-500">Quick Disbursal</p>
                </div>
              </div>
            </div>
