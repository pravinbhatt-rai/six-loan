...
import { ArrowRight, Bike, FileCheck, Banknote, ShieldCheck } from 'lucide-react';

// Placeholders - specialized for Bike/Automobile theme
const BIKE_IMAGE_URL = "https://images.unsplash.com/photo-1558981403-c5f9899a28bc?q=80&w=2070&auto=format&fit=crop"; 

const AVATAR_1 = "https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?auto=format&fit=crop&w=64&h=64";
const AVATAR_2 = "https://images.unsplash.com/photo-1599566150163-29194dcaad36?auto=format&fit=crop&w=64&h=64";
const AVATAR_3 = "https://images.unsplash.com/photo-1527980965255-d3b416303d12?auto=format&fit=crop&w=64&h=64";

export const UsedBikeHero: React.FC = () => {
  return (
      ...
      <div className="max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-0 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          <div className="flex flex-col items-start space-y-8 order-2 lg:order-1">
            ...
            {/* 1. Badge - Specific to Used Loans */}
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-teal-50 border border-teal-100 shadow-sm animate-fade-in-up">
              ...
              <span className="text-teal-700 text-sm font-semibold tracking-wide uppercase">
                Loans for Pre-Owned Two-Wheelers
              </span>
            </div>

            {/* 2. Headline - Focus on Affordability/Second Hand */}
            ...
            {/* 3. Subtext - Address Private Sellers/Dealers/Valuation */}
            <p className="text-lg text-slate-600 max-w-lg leading-relaxed">
              Buying from a dealer or a friend? We offer up to <strong>100% financing</strong> on the bike's valuation cost. Get quick approvals and assistance with RC transfer & insurance.
            </p>
              ...
              <div className="flex items-center gap-4">
                <div className="flex -space-x-3">
                  {[AVATAR_1, AVATAR_2, AVATAR_3].map((src, i) => (
                    <img key={i} src={src} alt="Happy Biker" className="w-10 h-10 rounded-full border-2 border-white ring-1 ring-slate-100 object-cover" />
                  ))}
                </div>
                <div className="text-sm">
                  <p className="font-bold text-slate-900">Free Vehicle Valuation</p>
                  <p className="text-slate-500">Know the fair price before buying</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="relative h-[500px] lg:h-[650px] w-full flex items-center justify-center order-1 lg:order-2">
            ...
            {/* Element 1: Valuation Badge (Critical for Used Bikes) */}
            <div className="absolute -left-6 top-20 z-20 bg-white p-4 rounded-2xl shadow-xl border border-slate-100 animate-bounce-slow max-w-[180px]">
              <div className="flex items-center gap-3 mb-2">
                ...
                <span className="text-xs font-bold text-slate-800">High LTV Ratio</span>
              </div>
              <div className="h-1.5 w-full bg-slate-100 rounded-full overflow-hidden">
                <div className="h-full bg-teal-500 w-[95%]"></div>
              </div>
              <p className="text-[10px] text-slate-500 mt-1 text-right">95% of Value Funded</p>
            </div>

            {/* Element 2: RC Support Badge */}
            <div className="absolute -right-4 bottom-32 z-20 bg-white p-4 rounded-2xl shadow-xl border border-slate-100 animate-float max-w-[200px]">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-sm font-bold text-slate-900">Paperwork Help</p>
                  <p className="text-xs text-slate-500">We handle RC Transfer</p>
                </div>
              </div>
            </div>
